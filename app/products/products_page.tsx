...
// SERVER COMPONENT — fetches products with Prisma, renders grid.
// SortDropdown extracted to its own client component file.
    ...
    <>
      ...
      <main className="max-w-screen-xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {/* Sidebar Filter — client component, wrapped in Suspense for useSearchParams */}
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center justify-between mb-6">
              ...
              {/* SortDropdown is a client component — updates URL on change */}
              <Suspense fallback={null}>
                <SortDropdown />
              </Suspense>
            </div>
